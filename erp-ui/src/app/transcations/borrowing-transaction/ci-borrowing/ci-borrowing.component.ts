...
view(rowData: any) {
  this.router.navigate([BorrowingTransactionConstant.CI_VIEW_BORROWING], { queryParams: { id: this.encryptDecryptService.encrypt(rowData.id),editbtn:this.encryptDecryptService.encrypt(applicationConstants.IN_ACTIVE)}});
}
editborrowing(rowData: any) {
  this.router.navigate([BorrowingTransactionConstant.CI_VIEW_BORROWING], { queryParams: { id: this.encryptDecryptService.encrypt(rowData.id) ,isGridPage:this.encryptDecryptService.encrypt(applicationConstants.IN_ACTIVE) }});
